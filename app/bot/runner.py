...
async def run_bot(
    ...
    logger.info(f"bot_data wired: redis={'ok' if redis_client else 'None'} bybit={'ok' if bybit_client else 'None'} session_manager={'ok' if session_manager else 'None'} db={'ok' if db_engine else 'None'}")
